...
from repository.db.sql import CREATE_SHIPPING
...
class ShippingRepository:
    ...
    async def create_shipping(self, order_uid: uuid4, email: str, status: str):
        return await self._connection.fetchrow(CREATE_SHIPPING, order_uid, email, status)
